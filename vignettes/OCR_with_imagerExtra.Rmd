...
Note that tesseract isn't available on Solaris.
...
`r if (!is_available_tesseract) {
  "OCR function and OCR_data function can't be used because tesseract is not available."
}'
