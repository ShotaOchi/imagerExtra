...
The functions in imagerExtra are classified into 3 groups by their function.
...
The parameter *sdn* is a standrd deviation of noise of image.
...
The function for image segmentation is
...
ThresholdTriclass(gdogs, stopval = 0.001) %>% plot(main = "stopval = 0.001", axes=F)
ThresholdTriclass(gdogs, repeatnum = 1) %>% plot(main = "repeatnum = 1", axes=F)
ThresholdTriclass(gdogs, repeatnum = 3) %>% plot(main = "repeatnum = 3", axes=F)
```